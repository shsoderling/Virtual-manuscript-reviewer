"""The LLM agent class for manuscript reviewers."""

from openai.types.chat import ChatCompletionMessageParam


class Agent:
    """An LLM agent representing a manuscript reviewer."""
    ...
    def __init__(
        ...
        :param title: The title of the agent (e.g., "Methodology Reviewer").
        :param expertise: The expertise of the agent.
        :param goal: The goal of the agent in the review process.
        :param role: The role of the agent in the review.
    ...
    def __eq__(self, other: object) -> bool:
        """Checks if the agent is equal to another agent."""
